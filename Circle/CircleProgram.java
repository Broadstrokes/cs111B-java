...
public class CircleProgram {
	public static void main(String[] args) {
		...
		test((testCircle1.getX() == 0), "Passed", "Failed", "should get x coordinate");
		test((testCircle1.getY() == 0), "Passed", "Failed", "should get y coordinate");
		...
		test((testCircle2.getX() == 3), "Passed", "Failed", "should get x coordinate");
		test((testCircle2.getY() == 2), "Passed", "Failed", "should get y coordinate");
		...
		test((testCircle3.getX() == 3), "Passed", "Failed", "should get x coordinate");
		test((testCircle3.getY() == 2), "Passed", "Failed", "should get y coordinate");
		...
		test((testCircle4.getX() == -6), "Passed", "Failed", "should get x coordinate");
		test((testCircle4.getY() == 4), "Passed", "Failed", "should get y coordinate");
		...
		test((testCircle1.getX() == 5), "Passed", "Failed", "should get updated x coordinate");
		test((testCircle1.getY() == 10), "Passed", "Failed", "should get updated y coordinate");
